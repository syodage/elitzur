...
private[elitzur] trait CompanionImplicit[T, A, C <: BaseCompanion[T, A]]
    extends Serializable {
  def companion: C
}

//scalastyle:off line.size.limit
case class SimpleCompanionImplicit[
    T,
    A <: com.spotify.elitzur.validators.BaseValidationType[T]
](companion: BaseCompanion[T, A])
    extends CompanionImplicit[T, A, BaseCompanion[T, A]]

case class DynamicCompanionImplicit[T, U, A <: DynamicValidationType[T, U, A]](
    companion: DynamicCompanion[T, U, A]
